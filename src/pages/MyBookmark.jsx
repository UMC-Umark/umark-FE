  ...
  return (
    <div>
      ...
      <div className='mx-12 my-8'>
        <h1 className="text-3xl font-bold mb-8">내가 쓴 북마크들</h1>
        ...
        <div className="flex items-center mb-12">
          ...
          <div className="w-32 h-32 bg-orange-500 rounded-full flex items-center justify-center text-black">
            <div className="text-center">
        ...
        <h2 className="text-3xl font-bold mb-4">your bookmark</h2>

        <hr className="border-b-2 border-black mb-8" />

        <div className="flex">
          {[1, 2, 3, 4].map((index) => (
            <div key={index} className="w-1/4 h-72 p-4 border-2 border-black relative mb-4 mr-4 bg-red-50">
              <FaTrashAlt
