    ...
    <div id="intro" className="overflow-hidden flex flex-col h-screen bg-white text-black">
      ...
      <div className="flex flex-col items-center mx-auto pt-24 pb-8 px-4 w-full">
        ...
        <div className="text-center my-8">
          ...
          <img src={icon1} alt="아이콘" className="mx-auto my-12 h-14 " />
          ...
          <div className="w-full flex justify-center"> 
            <p
              className="text-base md:text-2xl mb-4 mt-10 underline cursor-pointer transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
