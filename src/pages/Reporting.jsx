...
//   const [accesToken, setAccessToken] = useState(localStorage.getItem('accessToken')); // accessToken 상태 추가
...
//             }
//           });
//           console.log('Response with new token:', response.data);
//           setShowModal(true);
//           if (response.data.reported) {
//             navigate('/allbookmarks');
//           }
//         } catch (refreshError) {
//           console.error('Error on token refresh:', refreshError);
